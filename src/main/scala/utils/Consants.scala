...
object Consants {
  ...
  def getImageResource(card: Card, app: SimpleSwingApplication): ImageIcon = {
    card match {
      case WildCard(THREE, Diamond, _) => new ImageIcon(app.resourceFromClassloader("images/3_of_diamonds"))
      case WildCard(THREE, Club, _) => new ImageIcon(app.resourceFromClassloader("images/3_of_clubs"))
      case WildCard(THREE, Heart, _) => new ImageIcon(app.resourceFromClassloader("images/3_of_hearts"))
      case WildCard(THREE, Spade, _) => new ImageIcon(app.resourceFromClassloader("images/3_of_spades"))
      case NormalCard(FOUR, Diamond) => new ImageIcon(app.resourceFromClassloader("images/4_of_diamonds"))
      case NormalCard(FOUR, Club) => new ImageIcon(app.resourceFromClassloader("images/4_of_clubs"))
      case NormalCard(FOUR, Heart) => new ImageIcon(app.resourceFromClassloader("images/4_of_hearts"))
      case NormalCard(FOUR, Spade) => new ImageIcon(app.resourceFromClassloader("images/4_of_spades"))
      case NormalCard(FIVE, Diamond) => new ImageIcon(app.resourceFromClassloader("images/5_of_diamonds"))
      case NormalCard(FIVE, Club) => new ImageIcon(app.resourceFromClassloader("images/5_of_clubs"))
      case NormalCard(FIVE, Heart)  => new ImageIcon(app.resourceFromClassloader("images/5_of_hearts"))
      case NormalCard(FIVE, Spade)  => new ImageIcon(app.resourceFromClassloader("images/5_of_spades"))
      case NormalCard(SIX, Diamond)  => new ImageIcon(app.resourceFromClassloader("images/6_of_diamonds"))
      case NormalCard(SIX, Club) => new ImageIcon(app.resourceFromClassloader("images/6_of_clubs"))
      case NormalCard(SIX, Heart) => new ImageIcon(app.resourceFromClassloader("images/6_of_hearts"))
      case NormalCard(SIX, Spade) => new ImageIcon(app.resourceFromClassloader("images/6_of_spades"))
      case NormalCard(SEVEN, Diamond) => new ImageIcon(app.resourceFromClassloader("images/7_of_diamonds"))
      case NormalCard(SEVEN, Club) => new ImageIcon(app.resourceFromClassloader("images/7_of_clubs"))
      case NormalCard(SEVEN, Heart) => new ImageIcon(app.resourceFromClassloader("images/7_of_hearts"))
      case NormalCard(SEVEN, Spade) => new ImageIcon(app.resourceFromClassloader("images/7_of_spades"))
      case NormalCard(EIGHT, Diamond) => new ImageIcon(app.resourceFromClassloader("images/8_of_diamonds"))
      case NormalCard(EIGHT, Club) => new ImageIcon(app.resourceFromClassloader("images/8_of_clubs"))
      case NormalCard(EIGHT, Heart) => new ImageIcon(app.resourceFromClassloader("images/8_of_hearts"))
      case NormalCard(EIGHT, Spade) => new ImageIcon(app.resourceFromClassloader("images/8_of_spades"))
      case NormalCard(NINE, Diamond) => new ImageIcon(app.resourceFromClassloader("images/9_of_diamonds"))
      case NormalCard(NINE, Club) => new ImageIcon(app.resourceFromClassloader("images/9_of_clubs"))
      case NormalCard(NINE, Heart) => new ImageIcon(app.resourceFromClassloader("images/9_of_hearts"))
      case NormalCard(NINE, Spade) => new ImageIcon(app.resourceFromClassloader("images/9_of_spades"))
      case NormalCard(TEN, Diamond) => new ImageIcon(app.resourceFromClassloader("images/10_of_diamonds"))
      case NormalCard(TEN, Club) => new ImageIcon(app.resourceFromClassloader("images/10_of_clubs"))
      case NormalCard(TEN, Heart) => new ImageIcon(app.resourceFromClassloader("images/10_of_hearts"))
      case NormalCard(TEN, Spade) => new ImageIcon(app.resourceFromClassloader("images/10_of_spades"))
      case NormalCard(JACK, Diamond) => new ImageIcon(app.resourceFromClassloader("images/jack_of_diamonds"))
      case NormalCard(JACK, Club) => new ImageIcon(app.resourceFromClassloader("images/jack_of_clubs"))
      case NormalCard(JACK, Heart) => new ImageIcon(app.resourceFromClassloader("images/jack_of_hearts"))
      case NormalCard(JACK, Spade) => new ImageIcon(app.resourceFromClassloader("images/jack_of_spades"))
      case NormalCard(QUEEN, Diamond) => new ImageIcon(app.resourceFromClassloader("images/queen_of_diamonds"))
      case NormalCard(QUEEN, Club) => new ImageIcon(app.resourceFromClassloader("images/queen_of_clubs"))
      case NormalCard(QUEEN, Heart) => new ImageIcon(app.resourceFromClassloader("images/queen_of_hearts"))
      case NormalCard(QUEEN, Spade) => new ImageIcon(app.resourceFromClassloader("images/queen_of_spades"))
      case NormalCard(KING, Diamond) => new ImageIcon(app.resourceFromClassloader("images/king_of_diamonds"))
      case NormalCard(KING, Club) => new ImageIcon(app.resourceFromClassloader("images/king_of_clubs"))
      case NormalCard(KING, Heart) => new ImageIcon(app.resourceFromClassloader("images/king_of_hearts"))
      case NormalCard(KING, Spade) => new ImageIcon(app.resourceFromClassloader("images/king_of_spades"))
      case NormalCard(ACE, Diamond) => new ImageIcon(app.resourceFromClassloader("images/ace_of_diamonds"))
      case NormalCard(ACE, Club) => new ImageIcon(app.resourceFromClassloader("images/ace_of_clubs"))
      case NormalCard(ACE, Heart) => new ImageIcon(app.resourceFromClassloader("images/ace_of_hearts"))
      case NormalCard(ACE, Spade) => new ImageIcon(app.resourceFromClassloader("images/ace_of_spades"))
      case SpecialCard(TWO, Diamond) => new ImageIcon(app.resourceFromClassloader("images/two_of_diamonds"))
      case SpecialCard(TWO, Club) => new ImageIcon(app.resourceFromClassloader("images/two_of_clubs"))
      case SpecialCard(TWO, Heart) => new ImageIcon(app.resourceFromClassloader("images/two_of_hearts"))
      case SpecialCard(TWO, Spade) => new ImageIcon(app.resourceFromClassloader("images/two_of_spades"))
